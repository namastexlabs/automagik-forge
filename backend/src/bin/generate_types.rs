...
fn generate_types_content() -> String {
    ...
    let decls = [
        ...
        // Collaboration types
        automagik_forge::models::collaboration::PublicUser::decl(),
        automagik_forge::models::collaboration::PresenceStatus::decl(),
        automagik_forge::models::collaboration::UserPresence::decl(),
        automagik_forge::models::collaboration::CollaborationEvent::decl(),
        automagik_forge::models::collaboration::TaskCreatedEvent::decl(),
        automagik_forge::models::collaboration::TaskUpdatedEvent::decl(),
        automagik_forge::models::collaboration::TaskAssignedEvent::decl(),
        automagik_forge::models::collaboration::TaskAttemptEvent::decl(),
        automagik_forge::models::collaboration::UserPresenceEvent::decl(),
        automagik_forge::models::collaboration::ProjectUpdateEvent::decl(),
